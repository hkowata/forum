...
$lang = array_merge($lang, array(
	...
	'tokens'	=>	array(
		'TEXT'			=> '任何文本, 包括外文字符, 数字等等... 您不能在HTML标签中使用这种类型, 而必需使用 IDENTIFIER 或 SIMPLETEXT.',
...
// Disallow Usernames
$lang = array_merge($lang, array(
	'ACP_DISALLOW_EXPLAIN'	=> '这里您可以管理禁止使用的用户名. 可以使用通配符 *. 请注意这对已经注册的用户名是无效的',
	'ADD_DISALLOW_EXPLAIN'	=> '您可以使用通配符 *来禁止使用某类的用户名',
	'ADD_DISALLOW_TITLE'	=> '添加禁用用户名',

	'DELETE_DISALLOW_EXPLAIN'	=> '您可以通过点击列表中的用户名再点击提交来删除一个禁用的用户名',
	'DELETE_DISALLOW_TITLE'		=> '删除一个禁用的用户名',
	'DISALLOWED_ALREADY'		=> '您输入的用户名无法禁用. 它或者已经存在列表中, 或者存在于敏感词列表中, 或者与现存的用户名匹配.',
