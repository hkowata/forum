...
$lang = array_merge($lang, array(
	...
	'ACP_USERS_PERMISSIONS_EXPLAIN'				=> '这里您可以给用户设定全局权限 - 用户权限, 超级版主权限和管理员权限. 用户权限包含使用头像, 发送站内短信等等; 超级版主权限包含审阅帖子, 管理主题, 管理封禁等等; 管理员权限包含权限设定, BBCode设置, 版面管理等等. 对于大规模的用户权限设定请使用用户组权限方式. 用户的单独权限只在很少数的情况下需要更改, 推荐的方式是将用户归类在不同的用户组中, 再赋予用户组不同的权限.',
