...
$lang = array_merge($lang, array(
	...
	'LDAP_PASSWORD_EXPLAIN'			=> '如果绑定为匿名, 此处请留空. 否则请填入用户的密码. 这对于Active Directory Servers是必需的. <strong>警告:</strong> 此密码会被明文存储在数据库中, 对于任何可以访问数据库, 或者可以访问此控制面板的人都是可见的.',
	...
	'LDAP_UID_EXPLAIN'				=> '这是用于查找给定登录身份的关键字, 例如 <var>uid</var>, <var>sn</var>, etc.',
...
$lang = array_merge($lang, array(
	...
	'FORWARDED_FOR_VALID'			=> '经过验证的 <var>X_FORWARDED_FOR</var> 字段头',
