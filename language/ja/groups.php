...
$lang = array_merge($lang, array(
	...
	'CANNOT_JOIN_GROUP'			=> 'このグループに参加することはできません。参加できるグループは開放グループと申請制グループのみです。',
	'CANNOT_RESIGN_GROUP'			=> 'このグループから脱退することはできません。脱退できるグループは開放グループと申請制グループのみです。',
	...
	'GROUP_IS_OPEN'						=> 'このグループは申請制グループです。登録ユーザーなら誰でも参加を申請できます。',
	...
	'NOT_LEADER_OF_GROUP'			=> 'あなたはリーダーではないので、要求されたオペレーションを実行できません',
	'NOT_MEMBER_OF_GROUP'			=> 'あなたはメンバーでないかまだ承認されていないので、要求されたオペレーションを実行できません',
