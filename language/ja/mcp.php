...
$lang = array_merge($lang, array(
	...
	'MERGE_TOPIC_EXPLAIN'	=> 'ここでは選択した記事を他のトピックに統合できます。選択された記事は新しい返信記事として統合先トピックへそのまま追加されます。<br />統合先トピックの ID 番号を入力するか、 “トピック選択” をクリックして統合先トピックを検索してください。トピックの ID 番号はトピック表示ページの URL 中に含まれています（"t=" のすぐ後ろの数字列)。',
	'MERGE_TOPIC_ID'		=> '統合先トピックの ID',
	...
	'PM_REPORTS_ZERO_TOTAL'		=> '審査すべき通報 [ PM ] はありません',
	...
	'REPORTS_TOTAL'				=> '審査すべき通報が <strong>%d</strong> 件あります',
	'REPORTS_ZERO_TOTAL'		=> '審査すべき通報はありません',
	...
	'USER_CANNOT_REPORT'			=> 'パーミッションが与えられていないため、このフォーラムの記事を通報することはできません',
	...
	'report_reasons'		=> array(
		...
		'DESCRIPTION' => array(
			'WAREZ'		=> 'このメッセージ本文には 海賊版ソフト販売へのリンク が含まれています',
			'SPAM'		=> 'このメッセージ本文には 販売広告へのリンク が含まれています',
			'OFF_TOPIC'	=> 'このメッセージ本文は トピックの話題から外れて います',
			'OTHER'		=> 'その他。詳細に記述します。',
		)
	),
));
