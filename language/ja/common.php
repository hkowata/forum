...
$lang = array_merge($lang, array(
	...
	'ALL_TOPICS'					=> '全てのトピック',
	'AND'							=> 'And',
	'ARE_WATCHING_FORUM'			=> 'フォーラムの監視を開始しました。新しい記事が投稿されるとあなたに通知されます。',
	'ARE_WATCHING_TOPIC'			=> 'トピックの監視を開始しました。新しい返信が投稿されるとあなたに通知されます。',
	'ASCENDING'						=> '昇順',
	'ATTACHMENTS'					=> '添付ファイル',
	...
	'BCC'					=> 'BCC',
	'BIRTHDAYS'				=> '今日が誕生日',
	'BOARD_BAN_PERM'		=> 'あなたはこの掲示板へのアクセスを<strong>無期限に</strong>禁止されています。<br /><br />詳細は%2$s管理人%3$sに問い合わせてください。',
	'BOARD_BAN_REASON'		=> 'アクセス禁止の理由: <strong>%s</strong>',
	'BOARD_BAN_TIME'		=> 'あなたは <strong>%1$s</strong> までの間、掲示板へのアクセスを禁止されています。詳細は%2$s管理人%3$sに問い合わせてください。',
	'BOARD_DISABLE'			=> '申し訳ありませんが、掲示板は現在使用できません',
	'BOARD_DISABLED'		=> '掲示板は現在、停止しているため利用することはできません',
	'BOARD_UNAVAILABLE'		=> 'サーバの負担を減らすため有効なセッション数を制限しており、一部ユーザーに対して掲示板の使用が一時的に不可能になっております。誠に申し訳ありませんが、数分経ってからアクションを再試行して頂きますようお願い致します。その間、送信ボタンやページのリロードを何度もクリックしたりしないようお願い致します。',
	...
	'DISABLED'				=> '無効',
	'DISPLAY'				=> '表示',
	'DISPLAY_GUESTS'		=> 'ゲストユーザーを表示する',
	'DISPLAY_MESSAGES'		=> '期間内表示',
	'DISPLAY_POSTS'			=> '期間内表示',
	'DISPLAY_TOPICS'		=> '期間内表示',
	'DOWNLOADED'			=> 'Downloaded',
	'DOWNLOADING_FILE'		=> 'ファイルをダウンロード中',
	'DOWNLOAD_COUNT'	=> 'ダウンロード回数: %d 回',
	'DOWNLOAD_COUNTS'	=> 'ダウンロード回数: %d 回',
	'DOWNLOAD_COUNT_NONE'	=> 'ダウンロード回数: 0 回',
	'VIEWED_COUNT'	=> '表示回数: %d 回',
	'VIEWED_COUNTS'	=> '表示回数: %d 回',
	'VIEWED_COUNT_NONE'	=> '表示回数: 0 回',
	...
	'ENABLED'							=> '有効',
	'ENCLOSURE'							=> '囲み文字',
	'ERR_CHANGING_DIRECTORY'			=> 'FTP セッションを開始するに当たってカレントディレクトリをルートディレクトリに変更（CHDIR）できなかったため、プログラム処理を中断しました',
	...
	'ERR_UNWATCHING'					=> '監視の解除を実行中にエラーが発生しました',
	'ERR_WATCHING'						=> '監視の実行中にエラーが発生しました',
	...
	'FTP_FSOCK_ROOT_PATH_EXPLAIN'	=> 'Web公開ディレクトリから phpBB ルートディレクトリへの相対パスです',
	...
	'FTP_ROOT_PATH_EXPLAIN'		=> 'Web公開ディレクトリから phpBB ルートディレクトリへの相対パスです',
	...
	'LOGIN_CONFIRM_EXPLAIN'				=> '不正プログラムによるログインを防ぐため、一定回数ログインに失敗すると画像認証コードの入力が要求されます。画像が表示されない、もしくは視覚的に問題がある場合は%s管理人%sにご連絡ください。',
	'LOGIN_ERROR_ATTEMPTS'				=> '不正プログラムによるログインを防ぐため、一定回数ログインに失敗すると画像認証コードの入力が要求されます。ログインするにはユーザー名とパスワードだけでなく、画像に表示されている認証コードも入力してください。',
	'LOGIN_ERROR_EXTERNAL_AUTH_APACHE'	=> 'Apache による HTTP 認証に失敗しました',
	...
	'NOT_WATCHING_FORUM'		=> 'フォーラムの監視を解除しました',
	'NOT_WATCHING_TOPIC'		=> 'トピックの監視を解除しました',
	...
	'NO_AUTH_OPERATION'			=> 'パーミッションが与えられていないため、要求されたオペレーションを実行できません',
	...
	'NO_FORUM'					=> '要求されたフォーラムは存在しません',
	'NO_FORUMS'					=> 'フォーラムはありません',
	'NO_GROUP'					=> '要求されたグループは存在しません',
	...
	'NO_SUCH_SEARCH_MODULE'		=> '要求された検索バックエンドは存在しません',
	'NO_SUPPORTED_AUTH_METHODS'	=> '利用可能な認証方式がありません',
	'NO_TOPIC'					=> '要求されたトピックは存在しません',
	...
	'NO_USER'					=> '要求されたユーザーは存在しません',
	'NO_USERS'					=> '要求されたユーザーは存在しません',
	...
	'REPORT_BY'					=> 'ユーザー',
	'REPORT_POST'				=> 'この記事をリポートする',
	'REPORTING_POST'			=> '投稿記事をリポート中',
	'RESEND_ACTIVATION'			=> 'アカウント有効化メールの送信',
	'RESET'						=> 'リセット',
	'RESTORE_PERMISSIONS'		=> 'パーミッションテストを終了する',
	'RETURN_INDEX'				=> '%s掲示板トップへ%s',
	'RETURN_FORUM'				=> '%sフォーラムへ戻る%s',
	'RETURN_PAGE'				=> '%s元のページへ戻る%s',
	'RETURN_TOPIC'				=> '%sトピックへ戻る%s',
	'RETURN_TO'					=> 'Return to',
	...
	'SEARCH_ACTIVE_TOPICS'		=> '活発なトピックの表示',
	'SEARCH_FOR'				=> '検索',
	'SEARCH_FORUM'				=> 'このフォーラムを検索…',
	'SEARCH_NEW'				=> '新しい記事の表示',
	'SEARCH_POSTS_BY'			=> 'Search posts by',
	'SEARCH_SELF'				=> '自分の記事を表示',
	'SEARCH_TOPIC'				=> 'このトピックを検索…',
	'SEARCH_UNANSWERED'			=> '未返信記事の表示',
	'SECONDS'					=> '秒',
	'SELECT'					=> '選択',
	...
	'SORRY_AUTH_READ'			=> 'パーミッションが与えられていないため、フォーラムを閲覧できません',
	...
	'STATISTICS'				=> '統計データ',
	'START_WATCHING_FORUM'		=> 'このフォーラムを監視する',
	'START_WATCHING_TOPIC'		=> 'このトピックを監視する',
	'STOP_WATCHING_FORUM'		=> 'このフォーラムの監視を解除する',
	'STOP_WATCHING_TOPIC'		=> 'このトピックの監視を解除する',
	'SUBFORUM'					=> 'サブフォーラム',
	'SUBFORUMS'					=> 'サブフォーラム',
	'SUBJECT'					=> '件名',
	'SUBMIT'					=> '送信',
	...
	'TOO_LONG_LOCATION'				=> '入力した 所在地 が長すぎます',
	...
	'TOO_SHORT_LOCATION'			=> '入力した 所在地 が短すぎます',
	...
	'UNWATCHED_FORUMS'			=> '選択したフォーラムの監視を解除しました',
	'UNWATCHED_TOPICS'			=> '選択したトピックの監視を解除しました',
	'UNWATCHED_FORUMS_TOPICS'	=> '選択したフォーラムとトピックの監視を解除しました',
	'UPDATE'				=> '変更',
	'UPLOAD_IN_PROGRESS'	=> '現在アップロードの進行中です',
	'URL_REDIRECT'			=> 'ブラウザがページリダイレクトの METAタグ をサポートしていない場合、%sこちらをクリック%sしてください',
	'USERGROUPS'			=> 'グループ',
	'USERNAME'				=> 'ユーザー名',
	'USERNAMES'				=> 'ユーザー名',
	'USER_AVATAR'			=> 'アバター',
	...
	'VIEWS'						=> '閲覧数',
	'VIEW_BOOKMARKS'			=> 'ブックマークの表示',
	'VIEW_FORUM_LOGS'			=> 'フォーラムログの表示',
	'VIEW_LATEST_POST'			=> '最新記事の表示',
	'VIEW_NEWEST_POST'			=> '未読記事の表示',
	'VIEW_NOTES'				=> 'ユーザーノートの表示',
	'VIEW_ONLINE_TIME'			=> '過去 %d 分間のユーザーアクションに基づいています',
	'VIEW_ONLINE_TIMES'			=> '過去 %d 分間のユーザーアクションに基づいています',
	'VIEW_TOPIC'				=> 'トピック表示',
	'VIEW_TOPIC_ANNOUNCEMENT'	=> '告知トピックの表示 ',
	'VIEW_TOPIC_GLOBAL'			=> 'グローバル告知トピックの表示',
	'VIEW_TOPIC_LOCKED'			=> '閉鎖中トピックの表示',
	'VIEW_TOPIC_LOGS'			=> 'トピックログの表示',
	'VIEW_TOPIC_MOVED'			=> '移動済みトピックの表示',
	'VIEW_TOPIC_POLL'			=> '投票トピックの表示',
	'VIEW_TOPIC_STICKY'			=> '注目トピックの表示',
	'VISIT_WEBSITE'				=> 'ウェブサイトの訪問',
	...
	'dateformats'	=> array(
		...
		'Y/M/d H:i'			=> '2007/1/01 13:37',
		'Y/M/d g:i a'			=> '2007/1/01 1:37 pm',
		'd F Y H:i'			=> '01 1月 2007 13:37',
		'd F Y g:i a'			=> '01 1月 2007 1:37 pm',
		'|Y-M-d|, H:i'			=> 'Today, 13:37 / 2007-1-01, 13:37',
		'|Y-M-d|, g:i a'			=> 'Today, 1:37 pm / 2007-1-01, 1:37 pm',
