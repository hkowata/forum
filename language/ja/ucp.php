...
$lang = array_merge($lang, array(
	...
	'DELETE_COOKIES_CONFIRM'	=> 'この掲示板のすべての cookie を本当に削除してもよろしいですか？',
	...
	'LINK_REMOTE_SIZE_EXPLAIN'	=> 'アバター画像の横幅と高さを入力してください。空白（か 0 x 0 ）にした場合、自動で判別されます。',
	...
	'MESSAGE_REMOVED_FROM_OUTBOX'	=> 'このメッセージは受信前に送信者によって既に削除されました',
	'MESSAGE_SENT_ON'				=> 'on',
	...
	'GROUPS_EXPLAIN'	=> 'もし複数のグループに参加している場合、（管理人がデフォルトグループの変更を許可していれば）それらグループの中から１つだけデフォルトグループを選択できます。デフォルトグループとは、他のユーザーに対してあなたがどのように見えるか、例えばユーザー名の色、アバター画像、ランクなどを決定するためのグループです。（管理人が許可していれば）他のグループに参加することもできます。参加するグループによっては、それまでアクセスできなかったフォーラムへアクセスできるようになったり使えなかった機能が使えたりするようになるでしょう。',
