...
$lang = array_merge($lang, array(
	...
	'ACP_BAN_EXPLAIN'	=> 'ここではユーザー名、IPアドレス、メールアドレスを用いてユーザーのアクセスを禁止できます。アクセス禁止されたユーザーは掲示板にアクセスできなくなります。アクセス禁止されたユーザー名、IPアドレス、メールアドレスそれぞれに対してアクセス禁止した理由（最大で３０００字）をメモしておく事が可能です。このメモは Adminログ で表示されます。アクセス禁止の期限を指定することも可能です。もしアクセス禁止期限を特定の年月日までに指定したい場合、 <span style="text-decoration: underline;">期限指定 -&gt;</span> を選択して <kbd>YYYY-MM-DD</kbd> 形式で年月日を入力してください。 ',
	...
	'EMAIL_UNBAN_EXPLAIN'		=> '複数選択するにはマウスとキーボードをうまく活用してください（ Shiftキー または Ctrlキー を押しながらクリック）',
	...
	'IP_UNBAN_EXPLAIN'			=> '複数選択するにはマウスとキーボードをうまく活用してください（ Shiftキー または Ctrlキー を押しながらクリック）',
	...
	'USER_UNBAN_EXPLAIN'		=> '複数選択するにはマウスとキーボードをうまく活用してください（ Shiftキー または Ctrlキー を押しながらクリック）',
