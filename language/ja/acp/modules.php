...
$lang = array_merge($lang, array(
	'ACP_MODULE_MANAGEMENT_EXPLAIN'	=> 'ここではモジュールの管理を行うことができます。AdminCP は３階層メニュー構成（カテゴリ->カテゴリ->モジュール）、ユーザーCP と モデレータCP は２階層メニュー構成（カテゴリ->モジュール）で成り立っています。もし “モジュール管理” モジュール（今現在使用しているこのモジュール）を無効化または削除した場合、モジュール管理が一切できなくなってしまう事に注意してください。もしそうなった場合、元の状態に戻すにはデータベース内の modules テーブルを復元する必要があります。',
	'ADD_MODULE'					=> 'モジュールの追加',
