...
$lang = array_merge($lang, array(
	'BOTS'				=> 'ボットの管理',
	'BOTS_EXPLAIN'		=> 'ボット、スパイダー、クローラー とは、ロボット型ウェブページ巡回プログラムの事であり、そのほとんどは検索エンジンのデータベースの更新を目的としています。これらがゲストユーザーとしてサイトにアクセスした場合、セッションをめったに正常に扱わないためオンラインユーザー数をおかしくしたり、一般ユーザーのページの読み込み時間を増大させたり、時には間違ったページをインデックス化してしまったりします。ここではこれらの問題に対処するため、どのユーザーエージェントまたは IPアドレス がボットなのかを指定できます。',
	'BOT_ACTIVATE'		=> '有効にする',
	...
	'BOT_LANG'			=> '言語',
	'BOT_LANG_EXPLAIN'	=> 'ボットがどの言語で掲示板のページをインデックス化するかを指定できます',
