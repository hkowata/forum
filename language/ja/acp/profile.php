...
$lang = array_merge($lang, array(
	...
	'EDIT_DROPDOWN_LANG_EXPLAIN'	=> 'オプション名の変更と追加が可能です。新しいオプションを追加する場合は最下行に入力してください。もし既存のオプションの間に割り込んで追加してしまうとユーザーのプロフィール情報がそれに合わせて乱れてしまうので注意してください。オプションを削除する場合も同様です。もし最下行のオプションを削除した場合、そのオプションを選択している全ユーザーのプロフィールフィールド情報はデフォルト値に設定し直されます。',
	...
	'INVALID_CHARS_FIELD_IDENT'	=> 'フィールド名は 小文字(a-z) と アンダーバー(_) のみ含める事ができます',
	...
	'NO_VALUE_OPTION'			=> '非エントリーオプション',
	'NO_VALUE_OPTION_EXPLAIN'	=> 'ここで指定されたオプションは選択肢としてエントリーされません。必須フィールドの場合、このオプションを選択するとエラーが表示されます。ユーザーに対してフィールドの選択を促すような文のオプションを非エントリーオプションに指定すると良いでしょう。例えば 「以下の中から好きなものを選択してください」 など。',
	...
	'STEP_2_EXPLAIN_CREATE'			=> 'ここでは指定されたフィールドタイプについての特別な設定を行いことができます。',
	'STEP_2_EXPLAIN_EDIT'			=> 'ここでは指定されたフィールドタイプについての特別な設定を行うことができます。<br /><strong>ここでプロフィールフィールドを変更しても、既にユーザーが入力したユーザープロフィールは変更されない事に注意してください。</strong>',
	'STEP_2_TITLE_CREATE'			=> 'フィールドタイプ特別設定',
	'STEP_2_TITLE_EDIT'				=> 'フィールドタイプ特別設定',
	'STEP_3_EXPLAIN_CREATE'			=> '言語パックが複数インストールされているので、デフォルト言語以外の言語についても設定する必要があります。空白にした場合、デフォルト言語の設定がそのまま採用されます。',			
