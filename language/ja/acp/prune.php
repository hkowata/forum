...
$lang = array_merge($lang, array(
	...
	'DELETE_USER_POSTS_EXPLAIN' => 'アカウントを削除すると同時にそのユーザーが過去に投稿した全投稿記事も削除します。アカウント無効化の場合、効果はありません。',
	...
	'SELECT_USERS_EXPLAIN'		=> 'ユーザーを特定する場合はこのテキストボックスにユーザー名を入力してください。ここで特定したユーザー名は上記の条件設定より優先され、必ずアカウント 削除/無効化 されます。',
