...
$lang = array_merge($lang, array(
	...
	'CANNOT_DEACTIVATE_BOT'			=> 'ボットアカウントを停止する事はできません。かわりに スパイダー/ボット 管理ページで無効化してください。',
	'CANNOT_DEACTIVATE_FOUNDER'		=> 'ウェブマスターのアカウントを停止する事はできません',
	'CANNOT_DEACTIVATE_YOURSELF'	=> '自分自身のアカウントを停止する事はできません',
	...
	'CONFIRM_EMAIL_EXPLAIN'			=> 'ユーザーのメールアドレスを変更している場合のみ再入力する必要があります',
	...
	'FOUNDER'						=> 'ウェブマスター',
	'FOUNDER_EXPLAIN'				=> 'ウェブマスター（原文:Founder) は全ての Adminパーミッション を与えられた特別なユーザーです。ウェブマスターをアクセス禁止、アカウント停止、アカウント削除する事はできません。',
