...
define('ALPHA_PAGES_TABLE',			$table_prefix . 'alpha_pages');
define('ALPHA_PORTAL_TABLE',		$table_prefix . 'alpha_portal');
define('ALPHA_MODULES_TABLE',		$table_prefix . 'alpha_modules');
